...
TEST_SUITE("with a funny name,")
{
    ...
    {
        SUBCASE("with the funniest name\\,") { MESSAGE("Yes!"); }
        SUBCASE("with a slightly funny name :") { MESSAGE("Yep!"); }
        SUBCASE("without a funny name") { MESSAGE("NO!"); }
    }

    TEST_CASE("without a funny name:") { MESSAGE("Nooo"); }
}
